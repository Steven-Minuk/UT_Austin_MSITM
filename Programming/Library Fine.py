...
The fee structure is as follows:
    ...
    Changes are based only on the least precise measure of lateness. For example, whether a book is du January 1, 2017 or December 31, 2017,
...
Function Description
    ...
    libraryFine has the following parameter(s):
     ...
     - d2, m2, y2: due date day, month, and year, each in integer
...
t = [[9, 6, 2015], [6, 6, 2015]]
print(libraryFine(t[0][0], t[0][1],t[0][2],t[1][0],t[1][1],t[1][2]))